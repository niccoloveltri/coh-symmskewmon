...
-- some lemmata involving interpretation of antecedents
...
sound (ex {Δ = Δ} b f) = sound f ∘ [ s b ∣ Δ ]f
sound Ir = id
...
-- naturality of the morphisms ψ and φ
