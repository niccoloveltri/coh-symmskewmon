...
cmpltsound' (ex {S}{Γ} {Δ} f) =
  proof≗
    scut (cmplt [ s ∣ Δ ]f) (cmplt (sound f))
  ≗〈 cong-scut2 (cmplt [ s ∣ Δ ]f) (cmpltsound' f) 〉 
    scut (cmplt [ s ∣ Δ ]f) (⊗l⋆ _ (Γ ++ _ ∷ _ ∷ Δ) f)
  ≗〈 cong-scut1 {h = ⊗l⋆ _ (Γ ++ _ ∷ _ ∷ Δ) f} (cmplt-uf-lemma Δ s)  〉 
    scut (⊗l⋆ _ Δ {[]} (⊗l (⊗l (ex {Γ = []} (scut (⊗r (⊗r ax (uf ax)) (uf ax)) (⊗l-1⋆ _ Δ ax)))))) (⊗l⋆ _ (Γ ++ _ ∷ _ ∷ Δ) f) 
  ≗〈 ≡-to-≗ (scut⊗l⋆ {just (_ ⊗ _)}{Γ = Δ}) 〉 
    ⊗l⋆ _ Δ (⊗l (⊗l (ex {Γ = []} (scut (scut (⊗r (⊗r ax (uf ax)) (uf ax)) (⊗l-1⋆ _ Δ ax)) (⊗l⋆ _ (Γ ++ _ ∷ _ ∷ Δ) {[]} f)))))
  ≗〈 cong⊗l⋆ {just (_ ⊗ _)} {Δ} (⊗l (⊗l (ex {Γ = []} (~ scutscut-vass ((⊗r (⊗r ax (uf ax)) (uf ax))) (⊗l-1⋆ _ Δ ax) _)))) 〉 
    ⊗l⋆ _ Δ (⊗l (⊗l (ex {Γ = []} (scut {Γ = _ ∷ _ ∷ []} (⊗r (⊗r ax (uf ax)) (uf ax)) (scut (⊗l-1⋆ _ Δ ax) (⊗l⋆ _ (Γ ++ _ ∷ _ ∷ Δ) {[]} f))))))
  ≗〈 cong⊗l⋆ {just (_ ⊗ _)} {Δ} (⊗l (⊗l (ex (cong-scut2 (⊗r (⊗r ax (uf ax)) (uf ax)) (≡-to-≗ (scut⊗l-1⋆ {just (_ ⊗ _)}{Δ}{[]}{f = ax})))))) 〉 
    ⊗l⋆ _ Δ (⊗l (⊗l (ex {Γ = []} (scut {Γ = _ ∷ _ ∷ []} (⊗r (⊗r ax (uf ax)) (uf ax)) (⊗l-1⋆ _ Δ (⊗l⋆ _ (Γ ++ _ ∷ _ ∷ Δ) {[]} f))))))
  ≗〈 cong⊗l⋆ {just (_ ⊗ _)} {Δ} (⊗l (⊗l (ex (≡-to-≗ (cong (scut (⊗r (⊗r ax (uf ax)) (uf ax))) (cong (⊗l-1⋆ _ Δ) (⊗l⋆++ S Γ (_ ∷ _ ∷ Δ)))))))) 〉 
    ⊗l⋆ _ Δ (⊗l (⊗l (ex {Γ = []} (scut {Γ = _ ∷ _ ∷ []} (⊗r (⊗r ax (uf ax)) (uf ax)) (⊗l-1⋆ _ Δ {[]} (⊗l⋆ _ Δ (⊗l (⊗l (⊗l⋆ S Γ f)))))))))
  ≗〈 cong⊗l⋆ {just (_ ⊗ _)} {Δ} (⊗l (⊗l (ex (≡-to-≗ (cong (scut (⊗r (⊗r ax (uf ax)) (uf ax))) (⊗l⋆-iso {Γ = Δ})))))) 〉 
    ⊗l⋆ _ Δ (⊗l (⊗l (ex {Γ = []} (ccut [] (uf ax) (ccut (_ ∷ []) (uf ax) (⊗l⋆ S Γ f) refl) refl))))
  ≗〈 cong⊗l⋆ {just (_ ⊗ _)} {Δ} (⊗l (⊗l (ex (≡-to-≗ (ccut-unit [] (ccut (_ ∷ []) (uf ax) (⊗l⋆ S Γ f) refl) refl))))) 〉 
    ⊗l⋆ _ Δ (⊗l (⊗l (ex {Γ = []} (ccut (_ ∷ []) (uf ax) (⊗l⋆ S Γ f) refl))))
  ≗〈 cong⊗l⋆ {just (_ ⊗ _)} {Δ} (⊗l (⊗l (ex (≡-to-≗ (ccut-unit (_ ∷ []) (⊗l⋆ S Γ f) refl))))) 〉 
    ⊗l⋆ _ Δ (⊗l (⊗l (ex {Γ = []} (⊗l⋆ _ Γ f))))
  ≗〈 cong⊗l⋆ {just (_ ⊗ _)} {Δ} (⊗l (⊗l (ex⊗l⋆ S Γ f))) 〉 
    ⊗l⋆ _ Δ (⊗l (⊗l (⊗l⋆ _ Γ (ex f))))
  ≗〈 ≡-to-≗ (sym (⊗l⋆++ S Γ (_ ∷ _ ∷ Δ))) 〉 
    ⊗l⋆ _ (Γ ++ _ ∷ _ ∷ Δ) (ex f)
  qed≗
